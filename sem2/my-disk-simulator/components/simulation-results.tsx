...
export function SimulationResults({ results, diskSize }: Props) {
  if (results.length === 0) {
    return null; // Nie renderuj nic, jeśli nie ma wyników
  }

  // Znajdź najlepszy wynik (najmniejszy ruch głowicy)
          ...
          <Card
            ...
            <CardHeader>
              ...
              <CardDescription className="space-y-1">
                <p>Całkowity ruch głowicy: {result.totalMovement} cylindrów</p>
